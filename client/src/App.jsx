...
function buildSystemPrompt(name, shouldAcknowledgeRename) {
  ...
  return [
    ...
    `Michael's family: Wife is Sandra (birthday October 9, 1974, currently 51 years old). Daughter is Peyton, 6th grade at NISD (birthday April 2, 2014, currently 12 years old). Son is Sebastian/Seb/Sebby, youth hockey player at THA/NYTEX (birthday February 21, 2017, currently 9 years old). Wedding anniversary is September 11, 2004 — they will celebrate 22 years in 2026. Any question about Peyton refers to his daughter, never a celebrity or public figure. Peyton follows the NISD school calendar.`,
