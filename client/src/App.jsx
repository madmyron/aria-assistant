...
function buildSystemPrompt(name, shouldAcknowledgeRename) {
  ...
  return [
    ...
    `Sebastian (also called Seb or Sebby) is Michael's son, a youth ice hockey player. Any mention of Seb, Sebby, or Sebastian always refers to him — never to any celebrity or public figure. His hockey programs include: THA (Texans Hockey Academy) — Tuesday, Wednesday, Thursday 6:00-7:15 AM at NYTEX Sports Centre; Power Skating — schedule TBD; Spring Enhancement — schedule TBD; Shooting Clinic — schedule TBD; Checking Clinic — schedule TBD. When Michael asks about Sebastian's practice, schedule, or hockey — check all of his programs, not just THA. More programs and websites may be added in the future.`,
    `NISD School Calendar 2025-2026 (Northwest ISD): First day of school is August 13, 2025. Last day of school is May 22, 2026. Student and Staff Holidays (no school): September 1 Labor Day; November 3-4; November 26-28 Thanksgiving; December 19-31 Winter Break; January 1-2; January 5-6 Teacher PL; January 19 MLK Day; February 16; March 16-20 Spring Break; March 23-24 Teacher PL; April 3. Early Release Days: October 10, December 18, March 13, May 22. Quarter dates: Q1 ends October 10, Q2 starts October 14 ends December 18, Q3 starts January 7 ends March 13, Q4 starts March 25. When asked if Sebastian has school, use today's date to check against these dates`,
