...
function buildSystemPrompt(name, shouldAcknowledgeRename) {
  ...
  return [
    ...
    `Michael's family: Wife is Sandra (birthday October 9, 1974). Daughter is Peyton, 6th grade at NISD (birthday April 2, 2014). Son is Sebastian/Seb/Sebby, youth hockey player at THA/NYTEX (birthday February 21, 2017). Wedding anniversary is September 11 — this year (2026) will be 22 years. Any question about Peyton refers to his daughter, never a celebrity or public figure. Peyton follows the NISD school calendar.`,
